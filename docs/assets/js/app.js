...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // /** Commenting OUt for now as it was working and not any more :/
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menuBar a').each(function () {
  var myHref = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href');
